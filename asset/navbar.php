...
<nav class="navbar navbar-expand-lg sticky-top">
    <div class="container-fluid d-flex justify-content-between">
        <div class="d-flex flex-column nb">
            <a class="navbar-brand mx-auto py-0 text" href="http://ec2-18-117-246-170.us-east-2.compute.amazonaws.com/CloudGallery">S G</a>
        ...
        <div class="right-item d-flex justify-content-between">
            ...
            <div class="dropdown my-auto profile-dropdown">
                <a href="#" class="d-flex align-items-center link-dark text-decoration-none " id="dropdownUser2"
                    ...
                    <img src="http://ec2-18-117-246-170.us-east-2.compute.amazonaws.com/CloudGallery/public/image/default_user.png" alt="" width="32"
