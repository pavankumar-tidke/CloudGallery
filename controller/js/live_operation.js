...
function add_to_Favourite(i, display_category, media_id, media_name, folder_id=null) {
    ...
    var url = `http://ec2-18-117-246-170.us-east-2.compute.amazonaws.com/CloudGallery/controller/php/live_operation`;
    $.ajax({
        url: url,
        type: 'POST',
        data: {
...
function share_item(i, display_category, media_id, media_name) {
    ...
    let share_item = true;
    var url = `http://ec2-18-117-246-170.us-east-2.compute.amazonaws.com/CloudGallery/controller/php/share_handler`;
    var xhr = new XMLHttpRequest();
    xhr.open("POST", url, true);
    xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhr.onreadystatechange = function () { 
