...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/public/css/index.css?ver=1.4">
</head>
            ...
            <div class="2btn">
                <?php
                    if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
                        ...
                        echo '<div class="d-flex justify-content-center">
                                <a href="http://localhost/signup" class="btn default-btn bold theam-btn-hover text-light py-3 px-5">Let\'s create account <i class="bi bi-arrow-right-short mx-1"></i></a>
                            </div>';
                    }
                ?>
            </div>
