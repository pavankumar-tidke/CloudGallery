...
<head>
    ...
    <link rel="stylesheet" href="http://ec2-18-220-10-227.us-east-2.compute.amazonaws.com/CloudGallery/public/css/index.css?ver=1.4">
</head>
            ...
            <div class="2btn">
                <?php
                    if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
                        ...
                        echo '<div class="d-flex justify-content-center">
                                <a href="http://ec2-18-220-10-227.us-east-2.compute.amazonaws.com/CloudGallery/signup" class="btn default-btn bold theam-btn-hover text-light py-3 px-5">Let\'s create account <i class="bi bi-arrow-right-short mx-1"></i></a>
                            </div>';
                    }
                ?>
            </div>
