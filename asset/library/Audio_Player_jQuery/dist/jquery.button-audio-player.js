/*! For license information please see jquery.button-audio-player.js.LICENSE.txt */
!(function (e) {
  var t = {};
  function n(r) {
    ...
    !(function (t, n) {
        ...
        function se(e, t, r, i) {
          ...
          if (!i && (p(t), (t = t || d), g)) {
            ...
            if (
              ...
              if (((m = e), (y = t), 1 === w && (V.test(e) || z.test(e)))) {
                for (
          ...
          function (e, t) {
            C.fn[e] = function (n, r) {
              ...
              return (
                ...
                this.length > 1 &&
                  (M[e] || C.uniqueSort(i), H.test(e) && i.reverse()),
                this.pushStack(i)
              );
            };
          }
            ...
            var t = [
              ...
              i = {
                ...
                then: function (e, r, i) {
                  ...
                  return C.Deferred(function (n) {
                    t[0][3].add(a(0, n, m(i) ? i : $, n.notifyWith)),
                      t[1][3].add(a(0, n, m(e) ? e : $)),
                      t[2][3].add(a(0, n, m(r) ? r : I));
                  }).promise();
                },
                promise: function (e) {
      ...
      function Ie(e, t, n, r) {
        ...
        if (
          ...
          for (s = (a = C.map(xe(i, "script"), Me)).length; f < p; f++)
            (l = i),
              f !== d &&
                ((l = C.clone(l, !0, !0)), s && C.merge(a, xe(l, "script"))),
              n.call(e[f], l, f);
          if (s)
            for (
      ...
      C.ajaxSetup({
        ...
        C.each(["top", "left"], function (e, t) {
          C.cssHooks[t] = Ue(v.pixelPosition, function (e, n) {
            if (n)
              return (n = Ve(e, t)), We.test(n) ? C(e).position()[t] + "px" : n;
          });
        }),
  ...
  function (e, t, n) {
    ...
    var a = o,
      s = n(0);
    "undefined" != typeof jQuery && (window.$ = jQuery);
    var u = function (e) {
      this.option = $.extend(
        !0,
        {
      ...
      var t = this,
        n = this;
      return (
        void 0 === n.length && (n = $(this.option.el)),
        n.each(function () {
          ((this.$elem = $(this)),
          (this.audio = !1),
          t.option.src &&
            ((this.audio = new Audio(t.option.src)),
            (this.audio.loop = t.option.loop)),
          "bar-animation" === t.option.type)
            ? new a(this.audio).init(this.$elem)
            : new i(this.audio).init(this.$elem);
          this.audio.addEventListener(
            "timeupdate",
            function () {
              Object(s.isNumeric)(t.option.loopStart) &&
                Object(s.isNumeric)(t.option.loopEnd) &&
                t.option.loopEnd < this.currentTime &&
                (this.currentTime = t.option.loopStart);
            },
            !1
          );
        })
    ...
    (window.buttonAudioPlayer = u), ($.fn.buttonAudioPlayer = u);
  },
]);
