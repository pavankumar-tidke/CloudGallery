...
function home_content_view() {
  ...
  var url = `http://18.117.246.170/CloudGallery/controller/php/fetch_data`;
    ...
    if (this.readyState == 4 && this.status == 200) {
      ...
      if (responce_obj.recent.length > 0) {
        ...
        for (let x = 0; x < responce_obj.recent.length; x++) {
          ...
          // media source
          let media_src = `http://18.117.246.170/CloudGallery/storage/users/${uid}/recent/${responce_obj["recent"][x][2]}`;
          let mainCard = ``;
          let mediaCardFooter = `
    ...
    if (this.readyState == 4 && this.status == 200) {
      ...
      if (responce_obj.favourite.length > 0) {
        ...
        for (let x = 0; x < responce_obj.favourite.length; x++) {
          // media source
          let media_src = `http://18.117.246.170/CloudGallery/storage/users/${uid}/favourite/${responce_obj["favourite"][x][4]}`;
...
$(document).on("click", ".signout", function () {
  ...
  let logout = true;
  var xhr = new XMLHttpRequest();
  var url = `http://18.117.246.170/CloudGallery/controller/php/logout`;
