...
function onSuccess(googleUser) {
    ...
    xhr.open('POST', 'http://ec2-18-117-246-170.us-east-2.compute.amazonaws.com/CloudGallery/controller/php/google_auth.php');
    xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
    xhr.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            if(xhr.responseText == 'true') {
                window.location.href = `http://ec2-18-117-246-170.us-east-2.compute.amazonaws.com/CloudGallery/my-gallery`;
            }
...
$(document).on('click', '#login-btn', function(e) {
    ...
    if(email == '' || password == '') {
        ...
        let login = true;
        var xhr = new XMLHttpRequest();
        var url = `http://ec2-18-117-246-170.us-east-2.compute.amazonaws.com/CloudGallery/controller/php/auth`;
